<?php 
class m_jenis extends admin_controller{
	var $controller;
	function m_jenis(){
		parent::__construct();

		$this->controller = get_class($this);
		$this->load->model('m_jenis_model','dm');
...
function index(){
		$data_array=array();
		$content = $this->load->view("m_jenis_view",$data_array,true);

		$this->set_subtitle("Jenis");
		$this->set_title("Jenis");
