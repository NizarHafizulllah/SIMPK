...
<link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/bootstrap/bootstrap-dialog.min.css">
	...
	<body class="hold-transition skin-blue sidebar-mini">
	  ...
	  <div class="wrapper"> 
        ...
        <!-- Logo -->
		  <a href="<?php echo site_url('nasabah'); ?>" class="logo">
          <!-- mini logo for sidebar mini 50x50 pixels -->
			<span class="logo-mini"><b>N</b></span>
			<!-- logo for regular state and mobile devices -->
			<span class="logo-lg"><b>Nasabah </b></span>
		  </a>
			  ...
			  <ul class="nav navbar-nav">
					  ...
					  <li class="user-header">
							<p><?php echo $userdata['nama'] ?>
						  	<small><?php echo $userdata['no_hp'] ?></small>
								...
								<p><h2 style="color: white;">Nasabah</h2></p>
						</li>	
                  <!-- Menu Footer-->
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      <a href="<?php echo site_url('login/logout_nasabah'); ?>" class="btn btn-default btn-flat">Sign out</a>
                    </div>
                  </li>
					  </ul>
				  </li>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo site_url('nasabah_transaksi'); ?>"><i class="fa fa-circle-o"></i> Transaksi</a></li>
              </ul>
            </li>
          </ul>
        </section>
