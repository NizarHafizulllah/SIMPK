          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="<?php echo site_url('klaster'); ?>"><i class="fa fa-circle-o"></i> Klaster</a></li>
                <li><a href="<?php echo site_url('program'); ?>"><i class="fa fa-circle-o"></i> Program Profil</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="<?php echo site_url('admin_add_garis_miskin_kab'); ?>"><i class="fa fa-circle-o"></i> Garis Kemiskinan</a></li>
